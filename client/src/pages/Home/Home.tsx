			...
			<div className="stats-dashboard">
				...
				{statsError ? (
					<div className="stats-error">
						...
						<button className="btn btn-primary" onClick={() => navigate('/auth?mode=signin')}>
							Sign In
						</button>
					</div>
				) : (
			...
			<div className="quick-actions">
				...
				<div className="actions-grid">
					{quickActions.map((action, index) => (
						<button key={action.title} className="action-btn" onClick={() => navigate(action.path)} style={{ '--action-color': action.color } as React.CSSProperties}>
